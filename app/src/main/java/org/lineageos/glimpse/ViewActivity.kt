    ...
    private fun getMediaStoreMedia(uri: Uri) = runCatching {
        contentResolver.query(
            ...
            arrayOf(
                ...
                //MediaStore.Files.FileColumns.MEDIA_TYPE, // doesn't exist
            ...
            val isFavoriteIndex = it.getColumnIndexOrThrow(MediaStore.Files.FileColumns.IS_FAVORITE)
            val isTrashedIndex = it.getColumnIndexOrThrow(MediaStore.Files.FileColumns.IS_TRASHED)
            ...
            val orientationIndex =
                it.getColumnIndexOrThrow(MediaStore.Files.FileColumns.ORIENTATION)
